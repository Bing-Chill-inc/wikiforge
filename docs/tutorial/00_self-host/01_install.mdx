...
Nous vous proposons de recréer l'expérience proposée sur [AlgoForge.fr](https://algoforge.fr) en l'autohébergeant de 2 façons:
...
- Installer [git](https://git-scm.com/downloads).
- Installer [Bun](https://bun.sh), testé avec la version 1.2.6.

### Installation automatique Windows

1. Télécharger l'installateur de l'application. Nous vous proposons 2 méthodes pour cela:

- Sans Powershell: `run-local.bat` [disponible ici](https://github.com/Bing-Chill-inc/Algoforge-main/blob/main/run-local.bat)
- Avec Powershell: `run-local.ps1` [disponible ici](https://github.com/Bing-Chill-inc/Algoforge-main/blob/main/run-local.ps1)
