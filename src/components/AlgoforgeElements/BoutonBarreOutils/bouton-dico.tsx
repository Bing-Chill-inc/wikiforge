            ...
            <div id="dicobiblioControl">
                <button id="biblio_btn" data-title="Bibliothèque d'algorithmes">
                    ...
                    >
                        <g>
                            <path
                                d="M125.2,25.1v38.2c0-5.7-2.8-10.3-6.1-10.3H6.1c-1.7,0-3.2,1.2-4.3,3C0.7,57.9,0,60.5,0,63.3V25.1C0,11.2,28,0,62.6,0
c17.3,0,33,2.8,44.3,7.3C118.2,11.9,125.2,18.2,125.2,25.1z"
                            />
                            <path
                                d="M119.1,73.6H6.1C2.7,73.6,0,69,0,63.3v387.9c0-2.9,0.7-5.4,1.8-7.3c1.1-1.9,2.6-3,4.3-3h113c3,0,5.5,3.7,6,8.5v3.6
...
c0-6.9,4.6-12.5,10.3-12.5c2.9,0,5.4,1.4,7.3,3.7c1.9,2.3,3,5.4,3,8.8V373.2z"
                        ...
                        <path
                            d="M335.1,64.1c-2.3-4.7-8.5-8.9-17.3-12.1c-11.3-4.1-27-6.7-44.3-6.7c-34.6,0-62.6,10.3-62.6,22.9V103c0-2.8,0.7-5.4,1.8-7.3
...
c0-5.9,4.6-10.7,10.3-10.7c2.8,0,5.4,1.2,7.3,3.1c1.9,1.9,3,4.6,3,7.6v198.4c0,5.9-4.6,10.7-10.3,10.7s-10.3-4.8-10.3-10.7V195.4z"
                        ...
                        <path
                            d="M513.9,479.5l-4.9-38.4c0.6,5.4-1.4,11-4.7,11.5l-112.1,14.2c-2.9,0.4-6.2-6.4-7.4-11l5,39.4c1.7,13.8,30.9,21.4,65.2,17
...
c0.2-4.2,2.2-7.5,4.9-7.9l112-14.2c3.3-0.5,6.6,3.8,7.3,9.4C461,62.8,458.9,67.7,455.5,68.2z"
                ...
                <button
                    id="dico_btn"
                    data-title="Dictionnaire de données"
                    className="dico-selected"
                >
                    <svg
                        version="1.1"
                        id="boutonDico"
                    ...
                    >
                        <path
                            d="M439.1,453.3c-4.2-15.4-4.2-59.3,0-74.7c5.4-4.3,8.9-11.1,8.9-18.6V24c0-13.3-10.7-24-24-24H96C43,0,0,43,0,96v320
...
c0-17.6,14.4-32,32-32h285.4C379.5,401.1,379.5,430.9,381.4,448z"
            ...
            <div id="itemsControl" className="dock">
...
c0,0,0,0-0.1-0.1l-15.7-13.8c-0.3-0.3-0.9-0.3-1.2,0l-77.3,67.4C135.8,195.5,135.8,196.1,136.1,196.4L136.1,196.4z"
                            />
                            <polyline points="133.1,185.3 56.3,215.8 0.4,155.5 64.1,47.8 183.7,0.4 239.6,60.7 202.7,122.9 	" />
                        </g>
                    </svg>
                </div>
                <div className="svg-wrapper" data-title="Lien">
                    <svg
                        version="1.1"
                        id="boutonLien"
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
                        viewBox="0 0 535.1 535.1"
                        width="32"
                        height="32"
                    >
                        <path
                            d="M519.4,47.1L47.1,519.4c-8.7,8.7-22.8,8.7-31.4,0h0c-8.7-8.7-8.7-22.8,0-31.4L487.9,15.7c8.7-8.7,22.8-8.7,31.4,0v0
C528,24.4,528,38.5,519.4,47.1z"
                        />
                    </svg>
                </div>
                <div className="svg-wrapper" data-title="Problème">
                    <svg
                        version="1.1"
                        id="boutonProbleme"
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
                        viewBox="0 0 571.2 328.3"
                        width="32"
                        height="32"
                    >
                        <path
                            d="M548,0H23.2C10.4,0,0,10.5,0,23.5v281.3c0,13,10.4,23.5,23.2,23.5H548c12.8,0,23.2-10.5,23.2-23.5V23.5
                ...
                <div className="svg-wrapper" data-title="Procédure">
                    ...
                    >
                        <g id="Procedure">
                            ...
                            <path
                                d="M46.4,300.9h-3c-8.9,0-16.2-7.2-16.2-16.2V43.4c0-8.9,7.2-16.2,16.2-16.2h3c1.7,0,3.2,1.4,3.2,3.2v267.3
...
l-66.8,131.9v0h-163c-7.2,0-13.1-5.8-13.1-12.9V39.4c0-7.1,5.9-12.9,13.1-12.9h163v0l66.8,131.9C544,162,544,166.3,542.2,169.9z"
                ...
                <div className="svg-wrapper" data-title="Structure Switch">
                    ...
                    >
                        <path
                            d="M487.8,0H83.4c-2.1,0-4.1,1.2-5,3.1L2.6,153.3c-3.4,6.8-3.4,14.9,0,21.7l75.8,150.2c1,1.9,2.9,3.1,5,3.1h404.3
...
c4.9-5.9,12.2-9.4,20-9.4c4.8,0,9.3,1.3,13.3,3.7s7.3,5.8,9.5,10l12.1,22.6l38.7,72.3C551.7,295.1,551.4,304.8,546.8,312.6z"
                ...
                <div
                    ...
                    data-title="Structure itérative bornée"
                >
                    <svg
...
c4.9-5.9,12.2-9.4,20-9.4c4.8,0,9.3,1.3,13.3,3.7s7.3,5.8,9.5,10l12.1,22.6l38.7,72.3C551.7,295.1,551.4,304.8,546.8,312.6z"
                            ...
                            <path
                                d="M589.5,272.8c0-11.9,1.3-21.3,4-28.1c2.7-6.9,7-12.8,13.1-17.9c6-5,10.6-9.7,13.7-13.9c3.1-4.2,4.7-8.8,4.7-13.9
...
C586.7,320.9,584.5,315.9,584.5,309.9z"
                ...
                <div className="svg-wrapper" data-title="Condition de sortie">
                    <svg
                        version="1.1"
                        ...
                        x="0px"
                        y="0px"
                        viewBox="0 0 320.3 319.9"
                        width="32"
                        height="32"
                    >
                        <path
                            d="M277.5,26.9c8.6,0,15.6,7,15.6,15.6v234.9c0,8.6-7,15.6-15.6,15.6H42.6c-8.6,0-15.6-7-15.6-15.6V42.5
