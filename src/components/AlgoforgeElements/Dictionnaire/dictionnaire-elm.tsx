	...
	return (
		<div id="wrapper">
			<div id="dico-wrapper">
				...
				<div id="dico-inputs">
					<input id="inputs-name" type="text" name="" placeholder="Nom"></input>
					<input id="inputs-type" type="search" list="primitives" name="" placeholder="Type"></input>
					<input id="inputs-signification" type="text" name="" placeholder="Signification"></input>
